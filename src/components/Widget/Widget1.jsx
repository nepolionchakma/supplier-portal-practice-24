...
function Widget1(
  ...
  return (
    ...
    >
      ...
      <div className={`border-2 p-4 shadow-xl  touch-none duration-700 rounded bg-slate-400 w-[100%] mx-auto   ${minimize.includes(employee.employee_id) ? 'shadow-green-300 w-[80%] duration-700 mx-auto  ' : 'shadow-slate-600'} `}>
        <div
