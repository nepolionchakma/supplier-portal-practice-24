...
function MasterDetails2() {
  ...
  // const showDataPerPage = allEmployeesData?.slice(firstIndex, lastIndex);
  // const numerOfPage = Math.ceil(allEmployeesData?.length / itemPerPage);
  ...
  useEffect(() => {
    if (searchEmployeesNameData != '') setDataMap(searchEmployeesData)
    if (searchEmployeesNameDataFilteredDepartment != '') setDataMap(searchEmployeesDataByFilteredDepartment)
    if (searchEmployeesNameDataFilteredDepartment == '' &&
      searchValueById != '') setDataMap(searchEmployeesData)
    if (searchEmployeesNameData == searchValueById) setDataMap(allEmployeesData)
